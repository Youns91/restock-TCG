...
# -- Telegram --
TELEGRAM_TOKEN   = os.environ.get("TELEGRAM_TOKEN", "8681719781:AAHHkjpMv7jRBTZ4gFnZknYc_CN0GqM_9H8")
TELEGRAM_CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID", "8681719781")

# -- Email Outlook (optionnel en plus du Telegram) --
EMAIL_EXPEDITEUR   = os.environ.get("EMAIL_EXPEDITEUR", "u-nes91@hotmail.fr")
MOT_DE_PASSE       = os.environ.get("MOT_DE_PASSE", "Mangas12394.")
EMAIL_DESTINATAIRE = os.environ.get("EMAIL_DESTINATAIRE", "u-nes91@hotmail.fr")
